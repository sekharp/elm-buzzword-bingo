...
Elm.Bingo.make = function (_elm) {
   ...
   var totalPoints = function (entries) {
      return $List.sum(A2($List.map,function (_) {    return _.points;},A2($List.filter,function (_) {    return _.wasSpoken;},entries)));
   };
   ...
   var update = F2(function (action,model) {
      ...
      {case "NoOp": return model;
         ...
         default: var entryToAdd = A3(newEntry,model.phraseInput,$BingoUtils.parseInt(model.pointsInput),model.nextID);
           return isAddInvalid(model) ? model : _U.update(model,
   ...
   var entryForm = F2(function (address,model) {
      ...
      _U.list([A2($Html.input,
              ...
              _U.list([]))
              ,A2($Html.button,
              _U.list([$Html$Attributes.$class("add"),A2($Html$Events.onClick,address,Add),$Html$Attributes.disabled(isAddInvalid(model))]),
